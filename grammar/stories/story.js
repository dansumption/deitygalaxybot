...
module.exports = {
  story: [
    ...
    "#deityFull# is #twoPersonAction# #otherDeity# #deityPlace#. And the consequence is...?",
    ...
    "#deityFull# lives in #dwelling.a# #deityPlace#. Do you wish to build #dwelling.a# nearby?",
